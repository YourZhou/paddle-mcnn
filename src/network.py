...
def multi_column_cnn(inputs):
    large_column = large(inputs)
    medium_column = medium(inputs)
    small_column = small(inputs)
...
if __name__ == '__main__':
    input_img_data = fluid.data(name='image', shape=[1,3, 256, 256], dtype='float64')
